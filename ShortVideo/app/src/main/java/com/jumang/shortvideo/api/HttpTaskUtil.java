...
import com.jumang.shortvideo.api.Cryp.AesException;
import com.jumang.shortvideo.api.Cryp.EncriptAndroid;
import com.jumang.shortvideo.api.Cryp.SignUtil;
import com.jumang.shortvideo.api.OkHttpUtils.OkHttpUtils;
import com.jumang.shortvideo.api.OkHttpUtils.callback.Callback;
import com.jumang.shortvideo.data.SharedPreference;
...
public class HttpTaskUtil {
    ...
    //api地址
    public final static String BASE_URL = "http://app.hlytx.com:8080";
    ...
    private final static String APP_KEY = "3a5e5c01f5ff4d05a26edf7ad4f067bc";
...
//            String encryptstr = CryptUtil.encrypt(json);
            String encryptstr = EncriptAndroid.encrypt(json);//燕潇洒修改,原本使用CryptUtil类
