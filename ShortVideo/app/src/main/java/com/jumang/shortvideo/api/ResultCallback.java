...
import com.jumang.shortvideo.bean.ResponseBean;
import com.jumang.shortvideo.utils.JSONUtils;
import com.jumang.shortvideo.utils.UIHelper;
...
//                result = CryptUtil.decrypt(responseBean.getEncryptstr());
                result = EncriptAndroid.decrypt(responseBean.getEncryptstr());//燕潇洒修改,原本使用CryptUtil类
